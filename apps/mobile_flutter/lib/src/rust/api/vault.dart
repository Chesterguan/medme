...
// These functions are ignored because they are not marked as `pub`: `add_self_measurement_to`, `add_synthetic_document`, `collect_demo_files`, `detected_name_for`, `extraction_json_for`, `fmt_value`, `format_plausibility_violation`, `hex_to_bytes`, `home_monitoring_demo_entries`, `ingest_one`, `known_identity`, `machine_device_id`, `open_resilient_with_fallback`, `parse_measured_at`, `resolve_vault_paths`, `self_measured_label`, `self_measured_title`, `unwrap_restore_map`, `vault_cell`, `with_state_mut`, `with_state`, `wrap_restore_map`
