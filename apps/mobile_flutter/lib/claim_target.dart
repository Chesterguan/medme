...
class ClaimTarget {
  ...
  String get note => switch (how) {
    ClaimHow.merge => '你的病历箱里已经有「$name」,这份会并进去',
    ClaimHow.rename => '这是你的第一份病历,病历箱就用这个名字',
    ClaimHow.create => '会在你的病历箱里新建「$name」',
    ClaimHow.current => '这份病历里没有姓名,存进你现在这个成员',
  };
}
