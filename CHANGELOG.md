...
- **端到端加密分享**:AES-256-GCM 加密成一个自包含网页,凭口令在**任意浏览器本地
  ...
  [在线预览器](https://medmenow.com/viewer/)。
...
[Unreleased]: https://github.com/Chesterguan/medme/compare/v1.0...HEAD
[1.0]: https://github.com/Chesterguan/medme/releases/tag/v1.0
